...
export default function Login() {
  ...
  return (
    <>
      <div className="flex justify-center pt-60 pb-5">
        <Logo />
      </div>
      <div className="mb-8 pb-15 text-center">
        <h1 className="mb-2 text-sm font-bold text-gray-900">
          함께하니까, 더 나은 집중
        </h1>

        <p className="text-sm text-gray-600">
          지치지 않도록, 놓치지 않도록. 감정도 일도 함께합니다.
        </p>
      </div>
        ...
        <div className="w-full max-w-sm">
          <div className="space-y-4">
            ...
            >
              ...
              <span className="font-medium text-white">네이버로 시작하기</span>
            </button>
          </div>
