...
public final class JwtTokenProvider {
    ...
    private static final long TEMP_TOKEN_EXPIRATION = 30 * 60 * 1000L; // 30분
    ...
    public String getTokenSubject(String token) {
        try {
            ...
            log.error("Failed to get token subject: {}", e.getMessage());
            return null;
        }
    }
    ...
    public Long getBifIdFromToken(String token) {
        return getClaimsFromToken(token).get(BIF_ID, Long.class);
    }
